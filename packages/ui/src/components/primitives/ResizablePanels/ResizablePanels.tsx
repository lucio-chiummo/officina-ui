...
export function PanelHandle(props: ComponentProps<typeof PanelResizeHandle>) {
  return (
    <PanelResizeHandle
      {...props}
      className={cn(
        'group relative flex shrink-0 items-center justify-center rounded-sm bg-[var(--color-bg-muted)] select-none',
        ...
        'focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)]/25',
