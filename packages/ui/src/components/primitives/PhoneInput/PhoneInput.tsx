...
export function PhoneInput(props: PhoneInputProps) {
  return (
    <InternationalPhoneInput
      ...
      className="focus-within:!ring-3 focus-within:!ring-[var(--color-accent)]/15 !flex !h-9 !rounded-md !border !border-[var(--color-border-strong)] !bg-[var(--color-bg-base)] focus-within:!border-[var(--color-accent)]"
